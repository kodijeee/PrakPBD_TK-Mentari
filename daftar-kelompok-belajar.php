...
// $noinduk_siswa = $_GET['id'];
$nip_peg = $_SESSION['user_name'];

$query = "SELECT * FROM kelompok_belajar_vu";
...
<head>
  ...
  <title>Daftar Kelompok Belajar</title>
  <!-- plugins:css -->
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            <h2 class="col-lg-12 text-primary mb-4">Daftar Kelompok Belajar</h2>
                    ...
                    <div class="card">
                      <div class="card-body">
                        <?php 
                            ...
                            $total = mysqli_query($connect, "SELECT COUNT(*) AS 'total_siswa' FROM kelas_ajar_vu");
                            $jumlahsiswa = $total->fetch_assoc();
                        ?>
                        <div class="form-group row">
                          <div class="col-md-6">
                            <span class="mb-2 text-xs font-weight-bold">Tahun Ajaran &ensp;&nbsp;&ensp;&ensp;&nbsp;&ensp;&nbsp;&ensp;: 
                                <span class="mb-2 text-xs">
                                    <?php echo $data['tahun_ajar'];  ?> 
                                </span>
                            </span>
                            <br>
                            <span class="mb-2 text-xs font-weight-bold">Total Jumlah Siswa &ensp;: 
                                <span class="mb-2 text-xs">
                                    <?php echo $jumlahsiswa['total_siswa'];  ?> 
                                </span>
                            </span>
                            <br>
                          </div>
                          ...
                          <!-- <table class="table table-hover"> -->
                            ...
                            <tbody>
                                <?php foreach($sql as $data):
                                      ...
                                      $jumlah = $ambil['Jumlah'];?>
                                <tr>
                                  <td><?php echo $data['kelompokbel']?></td>
                                  <td><?php echo $data['nama_ruang_kelas']?></td>
                                  <td><?php echo $data['tingkatTK']==1?"TK-B":"TK-A"?></td>
                                  <td><?php echo $data['nama_peg']?></td>
                                  <td><?php echo $jumlah?></td>
                                  <td>
                                  <a href="daftar-siswa-kelompok-belajar.php?id=<?php echo $data['kelompokbel']; ?>" class="btn btn-warning">Show</a>
                                  </td>
                                </tr>
                                <?php endforeach ?>
                            </tbody>
