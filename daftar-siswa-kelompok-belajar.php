...
$query = "SELECT * FROM kelas_ajar_vu WHERE kelompokbel = '".$_GET['id']."'";
...
<head>
  ...
  <title>Daftar Siswa Kelompok Belajar</title>
  <!-- plugins:css -->
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            <h2 class="col-lg-12 text-primary mb-4">Daftar Siswa Kelompok Belajar</h2>
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="table-responsive">
                          <table class="display expandable-table dataTable no-footer" width="100%">
                          <!-- <table class="table table-hover"> -->
                            <thead>
                              <tr>
                                <th class="text-center" width="10%">NIS</th>
                                <th class="text-center" width="40%">Nama Siswa</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class="text-center"><?php echo $data['jenis_kelamin']==1?"L":"P"?></td>
                                  <td class="text-center"><?php echo $data['tgl_masuk']?></td>
                                </tr>
                                <?php endforeach ?>
                            </tbody>
                          </table>
