...
session_start();
$query = "SELECT * FROM detail_nilai_harian_vu
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-3 mb-2">
              <a class="btn btn-sm btn-primary" href="nilai-harian-siswa.php?id=<?php echo $ambil['noinduk_siswa']?>">
              BACK
              </a>
            </div>
            <h2 class="col-lg-6 text-primary text-center mb-2">Detail Nilai Harian</h2>
                  ...
                  <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <br>
                        <hr>
                        <a href="tambah-detail-harian.php?id=<?php echo $_GET['id'];?>" class="btn btn-sm btn-success btn-align-right">
                            + Tambah nilai
                        </a>
                        <div class="table-responsive">
                          ...
                          <!-- <table class="table table-hover"> -->
                            <thead>
                              <tr>
                                <th width="10%">No</th>
                                <th class="text-center">Kriteria Nilai Harian</th>
                            ...
                            <?php foreach($sql as $data):
                                  $idnilaihar = $data['id_nilai_harian'];
                                  $idkriteria = $data['id_kriteria_harian'];
                                  $function = mysqli_query($connect, "SELECT grade_nilai_harian('$idnilaihar','$idkriteria') 
                                                                      AS 'nilai_harian'");
                                  $nilai = $function->fetch_assoc();
                                  $grade = $nilai['nilai_harian'];
                              ?>
                                <tr>
                                  <td width="10%"><?php echo $counter++;?></td>
                                  <td class="text-center"><?php echo $data['nama_kriteria_harian']?></td>
                                  <td class="text-center"><?php echo $data['nilai_har']?></td>
                                  <td class="text-center"><?php echo $grade?></td>
                                  <td width="10%"><a href="edit_detail_nilai_harian.php?id=<?php echo $data['id_kriteria_harian']; ?>" class="btn btn-sm btn-warning">Edit</a></td>
                                  <td width="10%"><a href="hapus-detail-nilai-harian.php?id_kriteria_harian=<?php echo $data['id_kriteria_harian']; ?>" class="btn btn-sm btn-danger">Delete</a></td>
                                </tr>
                            </tbody>
                            <?php endforeach ?>
                          </table>
