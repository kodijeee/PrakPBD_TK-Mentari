              ...
              <div class="card">
                <div class="card-body">
                  <div class="col-lg-12">
                    <div class="card">
                      <div class="card-body">
                        <h3 class="text-center text-primary">Edit Detail Kriteria Nilai Harian </h3>
                        <hr>
                        <br>
                        <form action="" method="post">
                          <div class="form-group">
                            <label for="id_nilai_harian">ID Nilai Harian</label>
                            <input type="text" name="id_nilai_harian" class="form-control" id="id_nilai_harian" value="<?php echo $data['id_nilai_harian']; ?>" readonly required>
                          </div>
                          <div class="form-group">
                            <label for="id_kriteria_harian">Kriteria Harian</label>
                            <select class="form-control" name="id_kriteria_harian">
                                    <?php
                                    $ambil = $connect->query("SELECT * FROM kriteria_nilai_harian WHERE id_kriteria_harian = '".$_GET['id']."'");
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="nilai_har" class="form-control" id="nilai_har" value="<?php echo $data['nilai_har']; ?>" required>
                          </div>
                          <div class="form-group">
                            <button type="sumbit" name="update" class="btn btn-small btn-primary mr-2">Save</button>
                            <a href="detail-nilai-harian.php?id=<?php echo $data['id_nilai_harian'];?>" class="btn btn-small btn-light">Cancel</a>
                          </div>
                        </form>
                        <?php
                        ...
                        if (isset($_POST['update'])) { // di submit atau tidak ?
                            ...
                            $query = "UPDATE terdiri SET 
                                               nilai_har = '$nilai_har'
                                      WHERE id_nilai_harian = '$id_nilai_harian'
                                      AND id_kriteria_harian = '".$_GET['id']."'";
