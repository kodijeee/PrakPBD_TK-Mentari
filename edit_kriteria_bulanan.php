<?php
  ...
  $query = "SELECT * FROM kriteria_nilai_bulanan WHERE id_kriteria_bulanan =  '".$_GET['id_kriteria_bulanan']."'";
...
<head>
  ...
  <title>Edit Kriteria Nilai Bulanan</title>
  <!-- plugins:css -->
              ...
              <div class="card">
                <div class="card-body">
                  <div class="col-lg-12">
                    <div class="card">
                      <div class="card-body">
                        <h3 class="text-center text-primary">Edit Kriteria Nilai Bulanan</h3><hr>
                        <form action="" method="post">
                          <div class="form-group">
                            <label for="id_kriteria_bulanan">ID Kriteria Bulanan</label>
                            <input disabled type="text" name="id_kriteria_bulanan" class="form-control" id="id_kriteria_bulanan" value="<?php echo $data['id_kriteria_bulanan']; ?>" readonly required>
                          </div>
                          <div class="form-group">
                            <label for="nama_kriteria_bulanan">Nama Kriteria Bulanan</label>
                            <input type="text" name="nama_kriteria_bulanan" class="form-control" id="nama_kriteria_bulanan" value="<?php echo $data['nama_kriteria_bulanan']; ?>" maxlength="40" required>
                          </div>
                          <div class="form-group">
                            <button type="submit" name="edit" value="edit" class="btn btn-small btn-primary">Save</button>
                            <a href="kriteria-bulanan.php" class="btn btn-small btn-light">Cancel</a>
                          </div>
						            </form>
                        <?php
                        ...
                        if(isset($_POST['edit'])){
                            ...
                            $nama_kriteria_bulanan = $_POST['nama_kriteria_bulanan'];

                            $query_update = "UPDATE kriteria_nilai_bulanan
                                             SET nama_kriteria_bulanan  = '$nama_kriteria_bulanan'
                                             WHERE id_kriteria_bulanan = '".$_GET['id_kriteria_bulanan']."'";
                            $hasil = mysqli_query($connect, $query_update);
                            
                            if ($hasil) {
                                echo "<script>location='kriteria-bulanan.php';</script>";
                            } else {
