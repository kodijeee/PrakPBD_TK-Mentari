<?php
  ...
  $query = "SELECT * FROM kriteria_nilai_harian WHERE id_kriteria_harian =  '".$_GET['id_kriteria_harian']."'";
...
<head>
  ...
  <title>Edit Kriteria Nilai Harian</title>
  <!-- plugins:css -->
              ...
              <div class="card">
                <div class="card-body">
                  <div class="col-lg-12">
                    <div class="card">
                      <div class="card-body">
                        <h3 class="text-center text-primary">Edit Kriteria Nilai Harian</h3><hr>
                        <form action="" method="post">
                          <div class="form-group">
                            <label for="id_kriteria_harian">ID Kriteria Harian</label>
                            <input disabled type="text" name="id_kriteria_harian" class="form-control" id="id_kriteria_harian" value="<?php echo $_GET['id_kriteria_harian']; ?>" readonly required>
                          </div>
                          <div class="form-group">
                            <label for="nama_kriteria_harian">Nama Kriteria Harian</label>
                            <input type="text" name="nama_kriteria_harian" class="form-control" id="nama_kriteria_harian" value="<?php echo $data['nama_kriteria_harian']; ?>" maxlength="40" required>
                          </div>
                          <div class="form-group">
                            <button type="submit" name="edit" value="edit" class="btn btn-small btn-primary">Save</button>
                            <a href="kriteria-harian.php" class="btn btn-small btn-light">Cancel</a>
                          </div>
						            </form>
                        <?php
                        ...
                        if(isset($_POST['edit'])){
                            ...
                            $nama_kriteria_harian = $_POST['nama_kriteria_harian'];

                            $query_update = "UPDATE kriteria_nilai_harian
                                             SET nama_kriteria_harian   = '$nama_kriteria_harian'
