<?php
  ...
  $query = "SELECT * FROM tugas_prakarya WHERE id_tugasprak = '$id_tugasprak'";
              ...
              <div class="card">
                <div class="card-body">
                  <div class="col-lg-12">
                    <div class="card">
                      <div class="card-body">
                        <h3 class="text-center text-primary">Edit Tugas Prakarya</h3><hr>
                        <form action="" method="post">
                          <div class="form-group">
                            <label for="nama_tugasprak">Nama Tugas</label>
                            <input type="text" name="nama_tugasprak" class="form-control" id="nama_tugasprak" value="<?php echo $data['nama_tugasprak']; ?>" maxlength="20" required>
                          </div>
                          <div class="form-group">
                              <label for="deskripsi_tugasprak">Deskripsi Tugas</label>
                              <textarea type="text" name="deskripsi_tugasprak"class="form-control" id="deskripsi_tugasprak" rows="6" value="" maxlength="50"><?php echo $data['deskripsi_tugasprak']; ?></textarea>
                          </div>
                          <div class="form-group">
                            <label for="start_tugas">Start Tugas</label>
                            <input type="date" name="start_tugas" class="form-control" id="start_tugas" value="<?php echo $data['start_tugas']; ?>" required>
                          </div>
                            <div class="form-group">
                            <label for="end_tugas">End Tugas</label>
                            <input type="date" name="end_tugas" class="form-control" id="end_tugas" value="<?php echo $data['end_tugas']; ?>" required>
                          </div>
                          <div class="form-group">
                            <button type="submit" name="submit" class="btn btn-md btn-primary mr-2">Save</button>
                            <a href="tugas.php" class="btn btn-md btn-light">Cancel</a>
                          </div>
							          </form>
                        <?php
                        if (isset($_POST['submit'])) {
                          ...
                          $query = "UPDATE tugas_prakarya
                                    SET nama_tugasprak       = '$nama_tugasprak',
