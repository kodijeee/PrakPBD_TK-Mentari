...
$query = "SELECT * FROM kriteria_nilai_bulanan";
...
<head>
  ...
  <title>Kriteria Nilai Bulanan</title>
  <!-- plugins:css -->
    ...
    <div class="container-fluid page-body-wrapper">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="siswa">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="data-registrasi.php">Data RegistrasiData Saisw</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            <h2 class="col-lg-12 text-primary mb-4">Kriteria Nilai Bulanan</h2>
                          ...
                          <table class="display expandable-table dataTable no-footer" width="100%" role="grid">
                            ...
                            <tbody>
                              <?php foreach($sql as $data):?>
                                <tr>
                                  <td><?php echo $data['id_kriteria_bulanan']?></td>
                                  <td><?php echo $data['nama_kriteria_bulanan']?></td>
                                  <td class="text-center"><a href="edit_kriteria_bulanan.php?id_kriteria_bulanan=<?php echo $data['id_kriteria_bulanan']; ?>" 
                                  class="btn btn-md btn-warning">Edit</a></td>
                                </tr>
                            </tbody>
                            <?php endforeach ?>
                          </table>
