...
$query = "SELECT * FROM kriteria_nilai_harian ORDER BY id_kriteria_harian";
...
<head>
  ...
  <title>Kriteria Nilai Harian</title>
  <!-- plugins:css -->
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            <h2 class="col-lg-12 text-primary mb-4">Kriteria Nilai Harian</h2>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        <!-- <button href="tambah_tugas.php" class="btn btn-sm btn-success">
                           <i class="ti-plus"></i>
                        </button> -->
                        <a href="tambah-kriteria-harian.php" class="btn btn-sm btn-success btn-align-right">
                            <i class="ti-plus"></i>
                        </a>
                          ...
                          <table class="display expandable-table dataTable no-footer" style="width: 100%;" role="grid">
                            ...
                            <tbody>
                              <?php foreach($sql as $data):?>
                                <tr>
                                  <td><?php echo $data['id_kriteria_harian']?></td>
                                  <td><?php echo $data['nama_kriteria_harian']?></td>
                                  <td><a href="edit_kriteria_harian.php?id_kriteria_harian=<?php echo $data['id_kriteria_harian']; ?>" class="btn btn-md btn-warning">Edit</a></td>
                                  <td><a href="hapus-kriteria-harian.php?id_kriteria_harian=<?php echo $data['id_kriteria_harian']; ?>" class="btn btn-md btn-danger">Delete</a></td>
                                </tr>
                              <?php endforeach ?>
                            </tbody>
                          </table>
