    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            <h2 class="col-lg-12 text-primary mb-4">Nilai Bulanan</h2>
                            ...
                            <tbody>
                              <?php foreach($sql as $data):?>
                                <tr>
                                  ...
                                  <td>
                                  <a href="nilai-bulanan-siswa.php?id=<?php echo $data['noinduk_siswa']; ?>" class="btn btn-warning">Show</a>
                                  </td>
                                </tr>
                            </tbody>
                            <?php endforeach ?>
