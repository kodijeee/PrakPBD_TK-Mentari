...
session_start();
$query = "SELECT nilhar.*, sis.nama_siswa
          FROM nilai_harian nilhar JOIN siswa sis
          ON nilhar.noinduk_siswa = sis.noinduk_siswa
          WHERE sis.status_regis = '1'
          AND nilhar.noinduk_siswa = '".$_GET['id']."'";
...
<head>
  ...
  <title>Daftar Nilai Harian Siswa</title>
  <!-- plugins:css -->
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-3 mb-2">
              <a class="btn btn-sm btn-primary" href="nilai-harian.php">
              BACK
              </a>
            </div>
            <h2 class="col-lg-6 text-primary text-center mb-2">Daftar Nilai Harian Siswa</h2>
                  ...
                  <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <hr>
                        <a href="tambah-nilai-harian.php?id=<?php echo $noinduk?>" class="btn btn-sm btn-success btn-align-right">
                            + Tambah
                        </a>
                          ...
                          <table class="table table-hover">
                            ...
                            <tbody>
                              <?php foreach($sql as $data):?>
                                <tr>
                                  <td><?php echo $data['id_nilai_harian']?></td>
                                  <!-- <td><?php echo $data['noinduk_siswa']?></td> -->
                                  <td><?php echo $data['nama_siswa']?></td>
                                  <td><?php echo $data['tgl_ambil_nilai']?></td>
                                  <td>
                                  <a href="detail-nilai-harian.php?id=<?php echo $data['id_nilai_harian']; ?>" class="btn btn-warning">Show</a>
                                  </td>
                                  <td>
                                  <a href="edit_nilai_harian_siswa.php?id=<?php echo $data['id_nilai_harian']; ?>" class="btn btn-sm btn-info">Edit</a>
                                  </td>
                                </tr>
                            </tbody>
                            <?php endforeach ?>
