...
session_start();
$query = "SELECT * FROM raport WHERE noinduk_siswa = '".$_GET['id']."'";
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-3 mb-2">
              <a class="btn btn-sm btn-primary" href="rapor.php">
              BACK
              </a>
            </div>
            <h2 class="col-lg-6 text-primary text-center mb-2">Rapor Siswa</h2>
                  ...
                  <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <hr>
                        <a href="tambah-rapor.php?id=<?php echo $_GET['id'] ?>" class="btn btn-sm btn-success btn-align-right">
                            + Tambah
                        </a>
                        <div class="table-responsive">
                          <table class="table table-hover">
                            <thead>
                              <tr>
                                <th width="1%">Kode</th>
                                <th width="1%">Tanggal Ambil</th>
                                <th class="text-center">Catatan Rapor</th>
                                <th width="1%">Edit</th>
                              </tr>
                            </thead>
                            <tbody>
                            <?php while($data = mysqli_fetch_assoc($sql)) {?>
                                <tr>
                                  <td><?php echo $data['id_rapor'] ?></td>
                                  <td><?php echo $data['tgl_ambil_rapor']; ?></td>
                                  <td><?php echo $data['cat_rapor']; ?></td>
                                  <td>
                                  <a href="edit_rapor.php?id=<?php echo $data['id_rapor']; ?>" class="btn btn-warning">Edit</a>
                                  </td>
                                </tr>
                            </tbody>
                            <?php } ?>
