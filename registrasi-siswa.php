...
$query_siswa = "SELECT s.*, W.*
                FROM siswa s join walimurid w
                ON s.NIK_walmur = w.NIK_walmur
                WHERE status_regis = '0'";
$tabel_siswa = mysqli_query($connect, $query_siswa);
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            <h2 class="col-lg-12 text-primary mb-4">Registrasi Siswa</h2>
                      ...
                      <div class="card-body">
                        <div class="table-responsive">
                          <table class="table table-hover">
                            ...
                            <tbody>
                              <?php foreach($tabel_siswa as $datasiswa):?>
                                <tr>
                                  <td><?php echo $datasiswa['noinduk_siswa']?></td>
                                  <td><?php echo $datasiswa['nama_siswa']?></td>
                                  <td><?php echo $datasiswa['NIK_walmur']?></td>
                                  <td><?php echo $datasiswa['nama_walmur']?></td>
                                  <td><?php echo $datasiswa['jenis_kelamin']==1?"Laki-laki":"Perempuan"?></td>
                                  <td><?php echo $datasiswa['tgllahir']?></td>
                                  <td><?php echo $datasiswa['tgl_masuk']?></td>
                                  <!-- <td><?php echo $datasiswa['tgl_lulus']?></td> -->
                                  <td><?php echo $datasiswa['alamat']?></td>
                                  <td><?php echo $datasiswa['anakke']?></td>
                                  <td>
                                  <a href="verif_siswa.php?id=<?php echo $datasiswa['noinduk_siswa']; ?>" class="btn btn-success">VERIFY</a>
                                  </td>
                                </tr>
                            </tbody>
                            <?php endforeach ?>
