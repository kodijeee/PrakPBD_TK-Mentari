...
<head>
  ...
  <title>Tambah Detail Nilai Bulanan</title>
  <!-- plugins:css -->
                      ...
                      <div class="card-body">
                        ...
                        <form action="" method="post">
                          <div class="form-group">
                            ...
                            <input type="text" name="id_nilai_bulanan" class="form-control" id="id_nilai_bulanan" readonly value="<?php echo $_GET['id'];?>" required>
                          </div>
                          <div class="form-group">
                            ...
                            <select class="form-control" name="id_kriteria_bulanan">
                                <option value="">Pilih kriteria</option>
                                    <?php
                                    $sql = $connect->query("SELECT * FROM kriteria_nilai_bulanan");
                          ...
                          <div class="form-group">
                            <label for="nilai_bul">Nilai</label>
                            <input type="text" name="nilai_bul" class="form-control" id="nilai_bul" required>
                          </div>
                          <div class="form-group">
                            <button type="sumbit" name="tambah" class="btn btn-small btn-primary mr-2">Save</button>
                            <a href="detail-nilai-bulanan.php?id=<?php echo $_GET['id'];?>" class="btn btn-small btn-light">Cancel</a>
                          </div>
                        </form>
                        <?php
