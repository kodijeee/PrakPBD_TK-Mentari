<?php
  ...
  $query = "SELECT * FROM kriteria_nilai_harian";
...
<head>
  ...
  <title>Tambah Kriteria Nilai Harian</title>
  <!-- plugins:css -->
              ...
              <div class="card">
                <div class="card-body">
                  <div class="col-lg-12">
                    <div class="card">
                      <div class="card-body">
                        <h3 class="text-center text-primary">Tambah Kriteria Nilai Harian</h3>
                        <hr>
                        <br>
                        <form action="" method="post">
                          <div class="form-group">
                            <label for="nama_kriteria_harian">Nama Kriteria Harian</label>
                            <input type="text" name="nama_kriteria_harian" class="form-control" id="nama_kriteria_harian" maxlength="40" required>
                          </div>
                          <div class="form-group">
                        ...
                        if (isset($_POST['tambah'])) { // di submit atau tidak ?
                            ...
                            $query = "INSERT INTO kriteria_nilai_harian VALUES 
                                      ('','$nama_kriteria_harian')";
