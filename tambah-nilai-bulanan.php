<?php
  ...
  $sql = mysqli_query($connect, "SELECT * FROM nilai_bulanan WHERE noinduk_siswa = '".$_GET['id']."'");
  $siswa = $sql->fetch_assoc();
...
<head>
  ...
  <title>Tambah Nilai Bulanan</title>
  <!-- plugins:css -->
              ...
              <div class="card">
                <div class="card-body">
                  <div class="col-lg-12">
                    <div class="card">
                      <div class="card-body">
                        <h3 class="text-center text-primary">Tambah Nilai Bulanan </h3>
                        <hr>
                        <br>
                        <form action="" method="post">
                          <div class="form-group">
                            <label for="noinduk_siswa">NIS</label>
                            <input type="text" name="noinduk_siswa" class="form-control" id="noinduk_siswa" value="<?php echo $_GET['id'];?>" readonly required>
                          </div>
                          <div class="form-group">
                            <label for="bulan_ambil_nilai">Tanggal Ambil Nilai</label>
                            <input type="date" name="bulan_ambil_nilai" class="form-control" id="bulan_ambil_nilai" required>
                          </div>
                          <div class="form-group">
                            <button type="sumbit" name="tambah" class="btn btn-small btn-primary mr-2">Save</button>
                            <a href="nilai-bulanan-siswa.php?id=<?php echo $_GET['id'];?>" class="btn btn-small btn-light">Cancel</a>
                          </div>
                        </form>
                        <?php
                        ...
                        if (isset($_POST['tambah'])) { // di submit atau tidak ?
                            ...
                            $query = "INSERT INTO nilai_bulanan VALUES 
                                      ('','$noinduk_siswa','$bulan_ambil_nilai')";
