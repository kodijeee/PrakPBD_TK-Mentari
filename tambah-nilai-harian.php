...
//   $query = "SELECT * FROM nilai_harian";
  $sql = mysqli_query($connect, "SELECT * FROM nilai_harian WHERE noinduk_siswa = '".$_GET['id']."'");
...
<head>
  ...
  <title>Tambah Nilai Harian</title>
  <!-- plugins:css -->
              ...
              <div class="card">
                <div class="card-body">
                  <div class="col-lg-12">
                    <div class="card">
                      <div class="card-body">
                        <h3 class="text-center text-primary">Tambah Nilai Harian</h3>
                        <hr>
                        <br>
                        <form action="" method="post">
                          <div class="form-group">
                            <label for="noinduk_siswa">NIS</label>
                            <input type="text" name="noinduk_siswa" class="form-control" id="noinduk_siswa" value="<?php echo $_GET['id'];?>" maxlength="10" readonly required>
                          </div>
                          <div class="form-group">
                            <label for="tgl_ambil_nilai">Tanggal Ambil Nilai</label>
                            <input type="date" name="tgl_ambil_nilai" class="form-control" id="tgl_ambil_nilai" required>
                          </div>
                          <div class="form-group">
                            <button type="sumbit" name="tambah" class="btn btn-small btn-primary mr-2">Save</button>
                            <a href="nilai-harian-siswa.php?id=<?php echo $_GET['id'];?>" class="btn btn-small btn-light">Cancel</a>
                          </div>
                        </form>
                        <?php
