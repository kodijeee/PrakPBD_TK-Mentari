              ...
              <div class="card">
                <div class="card-body">
                  <div class="col-lg-12">
                    <div class="card">
                      <div class="card-body">
                        <h3 class="text-center text-primary">Tambah Rapor</h3>
                        <hr>
                        <br>
                        <form action="" method="post">
                          <div class="form-group">
                            <label for="noinduk_siswa">NIS</label>
                            <input type="text" name="noinduk_siswa" class="form-control" id="noinduk_siswa" value="<?php echo $_GET['id'] ?>" readonly maxlength="10" required>
                          </div>
                          <div class="form-group">
                            <label for="tgl_ambil_rapor">Tanggal Ambil Rapor</label>
                            <input type="date" name="tgl_ambil_rapor" class="form-control" id="tgl_ambil_rapor" required>
                          </div>
                          <div class="form-group">
                            <label for="cat_rapor">Catatan Rapor</label>
                            <textarea type="text" name="cat_rapor" class="form-control" id="cat_rapor" maxlength="100" rows="6" required></textarea>
                          </div>
                          <div class="form-group">
                            <button type="submit" name="tambah" class="btn btn-small btn-primary mr-2">Save</button>
                            <a href="rapor-siswa.php?id=<?php echo $_GET['id'] ?>" class="btn btn-small btn-light">Cancel</a>
                          </div>
                        </form>
                        <?php
                        ...
                        if (isset($_POST['tambah'])) { // di submit atau tidak ?
                            ...
                            $query = "INSERT INTO raport VALUES 
                                      ('', '$noinduk_siswa', '$cat_rapor', '$tgl_ambil_rapor')";
                            $tambah= mysqli_query($connect, $query);
                            
                            if ($tambah) {
                                echo "<script>location='rapor-siswa.php?id=$id';</script>";
                            } else {
