<?php 
  ...
  //ambil data dari database
    ...
    $query = "SELECT * FROM tugas_prakarya ORDER BY id_tugasprak";
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            <h2 class="col-lg-12 text-primary mb-4">Tugas Prakarya</h2>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        <!-- <h2 class="text-primary">Data Pembayaran Siswa</h2> -->
                        <!-- <p class="card-description">
                          Add class <code>.table-hover</code>
                        </p> -->
                        <a href="tambah_tugas.php" class="btn btn btn-success">
                          + Buat Tugas
                            ...
                            <tbody>
                              <?php while($data = mysqli_fetch_assoc($sql)) {?>
                                <tr>
                                  ...
                                  <td class="text-center"><a href="edit_tugas.php?id_tugasprak=<?php echo $data['id_tugasprak']; ?>" class="btn btn-md btn-warning" class="text-center">Edit</a></td>
                                  <td class="text-center"><a href="hapus-tugas.php?id_tugasprak=<?php echo $data['id_tugasprak']; ?>" class="btn btn-md btn-danger" class="text-center">Delete</a></td>
                                </tr>
                              <?php } ?>
                            </tbody>
                          </table>
