    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            <h2 class="col-lg-12 text-primary mb-4">Verifikasi Pembayaran</h2>
                            ...
                            <tbody>
                              <?php while($data = mysqli_fetch_assoc($sql)) {?>
                                <tr>
                                  ...
                                  <!-- <form action="verif_bayar.php" method="post">
                                    <td><a class="btn btn-success" onclick="return confirm('Apakah Anda Yakin Untuk Verifikasi?')">Verifikasi</a></td>
                                  </form> -->
                                  <td>
                                  <a href="verif_bayar.php?id=<?php echo $data['no_bayar']; ?>" class="btn btn-success">VERIFY</a>
                                  </td>
                                </tr>
                              <?php } ?>
                            </tbody>
